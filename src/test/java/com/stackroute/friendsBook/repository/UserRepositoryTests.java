...
//        Assert.assertEquals("a@gmail.com",list.get(0).getEmail());
        Assert.assertEquals("a@g.com",list1.get(0).getEmail());
    ...
    public void getAllUserEmails(){
        ...
        Assert.assertEquals("a@g.com", listEmail.get(0));
    }
    @Test
    public void getAllUserEmailsFailure(){        userRepository.save(user);
        List<String> listEmail = userRepository.getAllUserEmails();
